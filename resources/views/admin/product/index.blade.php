                            ...
                            <form action="{{ route('product.search') }}" method="POST">
                                ...
                                <div class="input-group input-group-sm">
                                    <input name="SearchProduct" type="text"
                                        ...
                                        id="SearchProduct" placeholder="{{ __('text.SearchProduct') }}"
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row mb-0">
                                <a href="{{ route('product.category.index') }}"
                                    class="btn btn-sm btn-outline-dark col-lg-6 col-xl-4">
                                    {{ __('text.CategoryManagement') }}
                                </a>
                                <a href="{{ route('product.create') }}"
                                    class="btn btn-sm btn-outline-success col-lg-6 col-xl-3">
